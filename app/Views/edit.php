...
<body>
  <nav class="navbar">
    <span class="navbar-brand">UPDATE BARANG <?= $barang['nama']; ?></span>
  ...
  <div class="container">
        <form action="/barang/update/<?= $barang['id']; ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" min="0" name="harga" value="<?= $barang['harga']; ?>" required>
            </div>
            <div class="form-group">
                <label for="stok">Stok Produk:</label>
                <textarea type="number" min="0" size="10" name="stok"><?= $barang['stok']; ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea type="text" name="deskripsi"><?= $barang['deskripsi']; ?></textarea>
            </div>
            <div class="form-group">
